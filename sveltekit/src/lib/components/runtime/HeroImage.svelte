<script lang="ts">
	...
	let { backgroundTheme = 'rain' }: { backgroundTheme?: 'rain' | 'snow' | 'none' } = $props();
...
<div class="hero-container">
	<img
		...
		src="/images/homepage/lofi-hero-bg.webp"
		alt=""
		bind:this={bgImageEl}
		width="500"
		height="500"
	...
	<div class="layer cloud-layer" class:cloud-hidden={showPlaceholder}>
		<img class="cloud-img" src="/images/homepage/lofi-hero-clouds.webp" alt="" />
		<img class="cloud-img" src="/images/homepage/lofi-hero-clouds.webp" alt="" />
	</div>
	...
	<img
		...
		class:hidden-layer={showPlaceholder}
		src="/images/homepage/lofi-hero-fg.webp"
		alt=""
	...
	<img
		...
		width="1000"
		height="1000"
		src="/images/homepage/lofi-placeholder-{backgroundTheme}.webp"
		loading="eager"
