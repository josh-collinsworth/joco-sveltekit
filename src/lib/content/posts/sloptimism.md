...
(_For those interested in the mundane details: I mostly only use the auto suggestions in VS Code, even though they're very hit and miss. I rarely use chat mode, and when I do, it tends to be mostly for rote tasks like format conversion. That's pretty much it. Every time I've tried giving AI more responsibility, it's let me down spectacularly. I am deeply skeptical that AI offers much of a real productivity boost in general, and that it's actually capable of good frontend code in particular. But that's mostly a moot point anyway, because my issues with AI go far, far beyond its effectiveness._)
