---
title: "For what it's worth: all my advice on job hunting in tech"
date: 2024-05-03
updated: 2024-05-03
categories:
  - opinion
...
Hence: this post. This will be a collection of all my knowledge gained, for whatever it's worth. I'll do my best to keep it up to date as the months and years roll on, but this is everything I know (or at least, am pretty sure I know) right now.
...
I don't claim to know everything, and I don't even claim what I _do_ know will be useful in the first place—both because what works for me might not work for you, and because most of my experience with job hunting came _before_ the major tech layoffs and large language models (LLMs, or "AI") that have defined this era of tech.

Still, though: I've had what I think is fair to consider a pretty good run in tech so far. I've been building things on the web for about ten years. I've worked for agencies, taught development courses, and most recently, I've been full-time in frontend for the last five years, at companies like [Flywheel/WP Engine](https://wpengine.com), [Shopify](https://shopify.com) and [Deno](https://deno.com).

So I don't know everything, but I think I've learned some things that might be useful to you.
...
I won't go deep into specifics on certain things, just because there are plenty of resources already available on those topics. (For example: how to write and design résumés, or understanding algorithms.) We _will_ cover some general advice on those topics, though.

Finally, I have to thank the members of the [ShopTalk Show](https://shoptalkshow.com) [D-D-D-Discord](https://www.patreon.com/shoptalkshow) for helping me flesh out this post with their own best suggestions and advice, especially [Dave Rupert](https://daverupert.com/), [Andrew Walpole](https://andrewwalpole.com/), and [Erick Merchant](https://erickmerchant.com/).
...
Before you get to the thrilling and wonderful world of filling out applications and telling strangers on the phone all about yourself in 90 seconds, you should check a few things off your list. (If you've started already, these are things you might want to work on sooner than later.)

### Know what you want

Obviously, what you want is a job, because you'd like to make money to eat and survive and pay for Netflix, please. But since that answer probably won't get you anywhere in interviews, let's go a little deeper.

What _kind_ of role best suits you, and in what type of organization? Do you like being a small part of a big team, and having well-defined criteria? Or, do you like having lots of autonomy and forging your own path? (Or somewhere between?)
...
Would you take less pay for something more fulfilling? What makes you feel fulfilled in the first place?

<CalloutPlusQuote>

Spend some serious time figuring out what you want, and where and how you work best, then put it down on paper.

</CalloutPlusQuote>

While I'm not generally a fan of personality tests and the like, I've found the [CliftonStrengths Assessment](https://www.gallup.com/cliftonstrengths/en/252137/home.aspx) (also called the StrengthsFinder, or Top Five Strengths) to be illuminating for me, personally. It's helped me to understand what works best for me, and where I fit in best.

Whether or not you take any tests, though, be honest with yourself about how you do your best work, and what sorts of responsibilities and organizations you're _not_ well suited for.

Write your answers down, and have them handy for interviews later. Meanwhile, these answers will help you filter your search.
...
Get at least conversational in any technology or area that's likely to come up in the kinds of roles you'll be going for. (_For modern frontend, this probably means React, TypeScript, and Tailwind, plus the basics of testing. These will change over the years, but that's how things sit as of this writing_.)

You don't need to be an expert in any of these things, by any stretch, but they shouldn't be wholly unfamiliar to you.

Beyond addressing any severe vulnerabilities, however: I personally believe time and energy is better spent bolstering strengths than mitigating weaknesses. There's usually a reason some things click with you while others don't, and so you're fighting against yourself trying to drag your lowest stats up. That energy goes a lot further leaning into things that come more easily. Plus, this is a long process; you need some wins along the way.
...
Even if you aren't looking locally, I'd still recommend seeking out groups for professionals like you, especially in your area. Get involved, and get to know the members. Go wherever the crowd happens to be.

<CalloutPlusQuote>

If you can make in-person connections, they'll likely be your strongest. Either way, be active online. Post helpful and friendly things. Become a name and face that people recognize and think of positively.

</CalloutPlusQuote>

Nobody likes the guy who pops into the jobs channel on day one and says "hey everyone, I need a job." Don't do that.

_Do_ let folks know you're looking, of course, but only _after_ you've gotten involved. These are communities, not charities; you shouldn't try to take from them without first contributing to and participating in them.
...
It's hard to stand out when you're the same circle avatar, on the same page, with the same boxes and colors as everyone else.
...
Your website doesn't need to be fancy; you don't have to blog (though it's a good idea, if you're into it at all); and you don't need to have a lot of pages or content. But your site absolutely _should_ exist in some form, and it should look professional. (After all, you're trying to get a job coding things. So for Pete's sake, make the things you code look really nice.)

If you aren't comfortable designing your own site, get some help, or use a template of some kind. If all else fails, copy something tasteful and minimalist. Having a website that looks amateurish probably hurts you more than not having one at all, so put in the work.

Similarly: you need some projects to show.
...
(This is less important if you've been in the industry a while, and your career track record speaks for itself.)
...
Get all the help you need on that second part. Seek feedback early and often. It's likely people will peer into the code, so make sure it's in good shape, and make it as accessible and performant as possible.
...
Use AI if that makes it easier; just be sure to read through the output extremely carefully. Only use AI for writing if you personalize it, and mask it well.
...
But if you can wield AI as a tool to enhance your _own_ writing, without sounding like a bot, so be it.

In any case: having these templates ready to go from the beginning will help minimize friction and time spent on tertiary tasks during the actual job search. (Hat tip to [Dave Rupert](https://daverupert.com/) for this idea.)
...
I'd do this even if you're specifically looking for remote jobs at (inter)national companies. You never know who knows somebody at Microsoft, or who used to work for Shopify. Getting regionally involved will likely pay off the best, as you'll already have things in common with that group of people, and building in-person relationships is much easier.

Again, however: be sure you're getting involved, and not just lurking for personal benefit.

---

Every job I've ever gotten or interviewed for has been through at least one of these venues; LinkedIn, Otta, Glassdoor, BuiltIn, and/or local connections. So while there are others available, and while I don't have any reason to dissuade you from being on more, that's a pretty solid foundation in my experience.
...
All right, you've covered your basics, and you're well prepared. Time to start sending out applications. Here's my advice on that process.
...
Your response rate will probably only be somewhere around 5–10%. That's not on you; it's just a weird, hard time in tech. But it does mean, on average, you'll need to apply to 10–20 jobs to get one response.
...
- Many won't get past the initial screen;
...
Your competition, if you want to call it that, is not nearly so voluminous as it appears.
...
I'd say if you want the job, go ahead and apply even if you feel you're only about half qualified. The truth is: the job posting will contain mostly stuff you'll probably learn on the job anyway. It's notoriously more rigorous than the actual role. So gather up all your positive data points about how you solve problems, and what a great coworker you are, and apply anyway.

<CalloutPlusQuote>

No job will give you your dream salary and benefits, so don't feel like you need to be their dream candidate.

</CalloutPlusQuote>

### Be active online

This is intentionally a retread of earlier advice, but it's important enough to bear repeating.

Remember: to the person reading your application and résumé, you are just another face in a bubble. It's tough to tell much about you at this stage. So if somebody gets as far as searching for you online, _give them something good to find_!

Have a website. Add a blog, if you're even remotely interested in writing (it helps to show your thinking style and communication skills). Have at least one live side project, however small, plus any socials you want to be on.

Be active, but go with quality over quantity; you don't want to seem like a bot. Show your human side. Focus on things that show who you are, what you're good at, and why somebody might want to get to know you and/or work with you. Be friendly and helpful. Get some good karma on your side.

People will only have a vague impression of you from your applications; round that out. Add some personality.
...
### Don't just say what you did; talk about the impact you had
...
But if you're fairly confident conversions went up by around 10%, or your best educated guess is that you saved the company $10,000 annually, go with it. If you're not comfortable with that, there's nothing wrong with saying "…by _approximately_ 10%," or "…saving the company _an estimated_ $10,000 annually."

Again, just to be unequivocal: don't make up things, and don't inflate numbers. But you're not filing financial reports with the SEC here. Honest estimates are fine.

**Bonus tip:** any time you find yourself telling a story like this in a résumé bullet point, convert it to a story you can use in an interview, and have a list written down and ready to go. Follow the STAR format (Situation - Task - Actions - Results). (Thanks again to Dave for that one.)

### Talk about yourself as a human, not just a technology checklist

Yes, you have to list every technology you've ever touched, because there's a chance you'll be filtered by whether or not the term "React" is on your résumé. It's boring and it's stupid, but that's the way this boring, stupid game works.
...
I'm certain you have positive qualities that aren't merely the software you know. It's the _overlap_ of those qualities and your hard skills together that creates your real value.
...
In my personal career: I know I've been valued at more than one company because I can communicate well with stakeholders, and explain things in simple terms (skills built from my years as an instructor). In some places, my coworkers were even so used to dealing with temperamental, stubborn developers, that it made me—someone willing and able to partner on goals—far more valuable than either soft skills or hard skills ever would've been on their own.
...
That's absolutely true. Once you hit a certain threshold, hard skills offer diminishing returns. In a healthy organization, at least, it doesn't matter how good you are at your job if nobody wants to be around you. No matter how technically brilliant you are, you're still a person, and you still have to communicate and work with other people.
...
So if that's where you struggle, work on _that_.

### Sweat the details

This piece of paper/digital document is the only thing someone knows about you. Make it look nice. And for the love of all that is good in this world, make sure you fix the typos.
...
They do this because it provides good insight into how you handle situations, so come prepared with stories. (Again: pulling from the stories you used in your résumé bullet points might be a good idea.)

Spend some time curating a list of at least 3–5 situations you can remember from previous situations, where you overcame adversity, dealt with conflict, saw something difficult through to successful completion, etc.

Here's one underrated tip:

<CalloutPlusQuote>

Your stories don't all have to be from a directly related job. All experience is relevant experience.

</CalloutPlusQuote>

If an interviewer asks to hear about a time you dealt with conflict, and the best example you have is the time you broke up a fight between the neighborhood kids over Pokémon cards, run with it (as long as it really is good).

If your best story about managing expectations throughout a project happens to come from your days of waiting tables, by all means, tell that story! It absolutely counts. (Your interviewer might even consider that pressure more impressive than the day-to-day of the workplace, and give you bonus points.)

Lastly: you don't have to make yourself look like a paragon of virtue in all of your stories. Be real. _Too_ perfect sends up red flags.

If they ask to hear about something that didn't go well, tell them. Just be sure to include what you learned, and how you'd handle that situation better in the future. (Sometimes, revealing you're a person who's capable of growth is all they're after.)

### Take the time you need

If you're asked a question, and you can't think of an answer right away, just say "let me think about that for a minute."

It's easy to feel the pressure to constantly perform in an interview, but anxiety and panic produce terrible results. It's perfectly fine to ask for time, and to take as much as you need. It will probably feel awkward as you sit there in silence, but it's just fine. Really. You won't get docked for that. (If you do, it's a red flag. But even in that case, the pause will probably produce a better result than hastily fumbling through a bad answer.)

### Never, ever, ever, EVER say bad things about previous jobs or coworkers
...
You might think I'm saying this because nobody likes a complainer. True enough. But there's more, in the form of a psychological quirk of the human brain:

<CalloutPlusQuote>

When someone reports a problem, the human brain automatically draws an association between that problem and the person who's reporting it. We look for the other side of the story, and intuitively, believe the problem is somehow that person's fault.
...
Plus, it's just pretty tactless to denigrate parties who aren't present to defend themselves anyway, so just don't do it. Save those stories for when you get to know your new coworkers better.
...
Most interviews will end with 5–10 minutes for you to ask anything you'd like. Don't pass up this valuable opportunity. Come prepared with some things you'd really like to know. Have a list prepared.
...
## 6. Handling live coding interviews
...
Besides, performance in that environment has no correlation with real-world job performance, or what it's like to actually be a developer. No manager at any sane company will _ever_ show up at your desk with a problem you've never seen before, set a timer for 30 minutes, and sit there and watch you work on it. It just doesn't happen.
...
Anyway, I digress. Unfortunately, most companies still do these arcane, bias-ridden exercises, and so you'll probably have to take some.
...
Before you're in an actual interview, get in front of people, and talk as you type. Make mistakes. Talk about your mistakes. Keep going, until it stops being so uncomfortable. Do it often.
...
I know it's painful. I know some people just aren't suited for this kind of thing. I'm sorry. It's stupid. But I know you can do it. It just takes practice.
...
The more you talk through what you're doing, the better. You're here to show how you think through things, how you approach solving problems, and how you communicate, not just to mash some code out to finish a puzzle.
...
I know the situation might feel very uncomfortable, but don't let the time constraints push you into rushing. Take deep breaths as needed. As much as you can, be of calm mind and body. (The practice helps with this.)

If you sense yourself getting anxious, just stop and breathe for a minute, even if it seems like you're shooting yourself in the foot by taking that time off the clock. By all means, feel free to tell your interviewer you're taking a moment to think through the problem. (You don't need permission for this.)
...
1. Where does the number get high enough it would be hard to say no?
2. Where does the number get low enough it would be hard to say yes?
...
In that scenario, there's nothing wrong with saying something like "I am expecting a salary in the range of $75 to $85k," or even $80–$90. Don't shoot the moon and ask for a wildly unrealistic number, of course, but don't be afraid to ask a little high, either.

You're probably not going to get rejected over a slight difference; most likely, whoever you're talking to will just say something like, "that's slightly high for this role," at which point you can still work on coming to an agreement, if you want to. (And if they shut the door on you over a measly percentage difference, walk away knowing you dodged a bullet.)
...
- Are there other perks, like retirement funds and 401k matching?
...
Or, you might not care at all about the dollar value. Maybe you just want a more fulfilling role at a better company.

Ultimately it's up to you what's most valuable in a new position. I'd just say: don't over-weight any one factor. Money makes up for poor perks better than the other way around, but no amount of money can make a bad job pleasant.
...
I won't sugarcoat it: this is a weird, hard time for everyone in tech. As the general economy around us continues humming along steadily, our sector has, for various and hotly debated reasons, chilled severely. It's a rough time, and again: that's nothing to do with you.

Anecdotally, however: I can tell you that ever since I put the word "developer" on my LinkedIn profile, I've gotten regular, sometimes _relentless_ recruiter spam. (In fact, I've joked before that the best way to get a job as a developer is to say you already are one.)

That all went silent at some point in the last year or so, but I've noticed it beginning to tick back up again lately.

My personal take (again, purely anecdotal) is: companies have started to realize laying off so much of their staff over the last year or two has made them a lot slower than they'd like to be. On top of this, the much-feared recession that helped lead to the layoffs in the first place never really materialized (tech's current downturn notwithstanding).
...
Just keep putting one foot in front of the other, doing little things each day to get 1% better, and it'll pay off in the long run.
...
Remember, this has to be a match from both sides, and every company will be looking for something different. You _are_ a fit somewhere. You _will_ be valued somewhere. But you just can't expect to find that without spending a lot of time looking.
