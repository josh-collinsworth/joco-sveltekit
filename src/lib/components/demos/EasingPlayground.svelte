...
>
	<div class="intro intro-mobile">
		...
		<p>
			...
			your own. (Made to accompany <a href="/blog/easing-curves">this post</a>.)
		</p>
	</div>
	...
	>
		...
		>
			...
			/>
			<path
				class="current-curve__curve"
				d="M20,200 C{startHandleX},{startHandleY} {endHandleX},{endHandleY} 120,100"
			/>

			<g class:transparent={dragging}>
				<line
					class="current-curve__handle-tether"
					x1="20"
					y1="200"
					x2={startHandleX}
					y2={startHandleY}
				...
				/>
				<g
					class="current-curve__moving-circle-wrapper"
					style="--bezierCoordinates: {bezierCoordinates}"
				>
	...
	<div>
		<div class="intro intro-desktop">
			<h2>CSS easing playground</h2>
			<p>
				A place to try out various easing types/cubic bézier curves, and to
				create your own. (Made to accompany <a href="/blog/easing-curves"
					>this post</a
				>.)
			</p>
		</div>
						...
						<label for={title} class={title.slice(0, 4)}>
							...
							>
								...
								<path
									...
									d="M0.2,1.2 C{curve[0] + 0.2},{1.4 -
										(curve[1] + 0.2)} {curve[2] + 0.2},{1.4 -
										(curve[3] + 0.2)} 1.2,0.2"
								/>
							</svg>
