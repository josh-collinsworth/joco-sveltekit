...
1. **Don't act on feelings alone**. Feelings are frequently deceiving.

    The ability to think rationally and honestly about your own emotions is a crucial and undervalued skill. Being able to acknowledge what we feel, and that it may be incorrect, misleading, or even based on nothing at all, is absolutely key. And it's _especially_ pivotal in a world where entire industries have been built on manipulating emotion.
