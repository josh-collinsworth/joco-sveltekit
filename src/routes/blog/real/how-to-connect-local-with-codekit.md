...
![CodeKit (on a Vue project, and in dark mode)](../assets/images/post_images/codekit-window.png)
...
![Creating a new site in Local](../assets/images/post_images/local-new-site-setup.png)
...
![Port conflict warning](../assets/images/post_images/port-conflict.png)
...
![A Local CodeKit project](../assets/images/post_images/codekit-public-folder.png)
...
![CodeKit's Project Settings > Browser-Refreshing area](../assets/images/post_images/Image-2020-02-20-at-9.10.43-PM-1024x699.png)
...
![Toggle External Server on, and enter your Local site's Site Host URL as the address](../assets/images/post_images/image-1024x557.png)
...
![The Browser Preview button](../assets/images/post_images/image-1-1024x155.png)
...
![Make sure the TLS setting in CodeKit matches your Local site's protocol](../assets/images/post_images/codekit-preview-window.png) 
...
![Select a file to see the compilation options](../assets/images/post_images/image-2-1024x865.png)
...
![Errors shown in CodeKit](../assets/images/post_images/image-3-1024x449.png)
