...
<template>
  ...
  <ul>
    <li>
      <strong><a rel="external" href="code.visualstudio.com/">Visual Studio Code</a></strong>:
      ...
      <ul>
        ...
        <li>
          ...
          <ul>
            <li>
              <strong><a rel="external" href="marketplace.visualstudio.com/items?itemName=Tobermory.es6-string-html">es6-string-html</a></strong>:
            ...
            <li>
              <strong><a rel="external" href="marketplace.visualstudio.com/items?itemName=CoenraadS.bracket-pair-colorizer">Bracket Pair Colorizer</a></strong>:
              makes it easier to distinguish where a code block ends by assigning the same color to the opening and closing brackets.
            </li>
            <li>
              <strong><a rel="external" href="marketplace.visualstudio.com/items?itemName=pnp.polacode">Polacode</a></strong>:
              a nifty, pretty way to take code screenshots
            </li>
            <li>
              <strong><a rel="external" href="marketplace.visualstudio.com/items?itemName=MS-vsliveshare.vsliveshare">Live Share</a></strong>:
              the best way to collaborate on code remotely that I’ve ever used.
            </li>
            <li>
              <strong><a rel="external" href="marketplace.visualstudio.com/items?itemName=eamodio.gitlens">GitLens</a></strong>:
            ...
            <li>
              <strong><a rel="external" href="marketplace.visualstudio.com/items?itemName=Compulim.compulim-vscode-closetag">Close HTML/XML Tag</a></strong>:
            ...
            <li>
              <strong><a rel="external" href="https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-rename-tag">Auto Rename Tag</a></strong>:
            ...
            <li>
              <strong><a rel="external" href="https://marketplace.visualstudio.com/items?itemName=usernamehw.errorlens">Error Lens</a></strong>:
    ...
    <li>
      <strong><a rel="external" href="www.mozilla.org/en-US/firefox/new/">Firefox</a></strong>:
    ...
    <li>
      <strong><a rel="external" href="www.iterm2.com/">iTerm2</a></strong>:
  ...
  <ul>
    ...
    <li>
      ...
      <strong><a rel="external" href="sass-lang.com/">SCSS</a></strong>). I love authoring smooth, fluid transitions and animations.
    </li>
    <li>
  ...
  <ul>
    <li>
      <strong><a rel="external" href="www.anker.com/products/variant/xanker-24g-wireless-vertical-ergonomic-optical-mouse/xa7852011">Anker 2.4G Wireless Vertical Ergonomic Optical Mouse</a></strong>:
    ...
    <li>
      <strong><a rel="external" href="https://kinesis-ergo.com/shop/freestyle2-mac/">Kinesis Freestyle2 for Mac</a></strong> keyboard:
    ...
    <li>
      <strong><a rel="external" href="https://www.hermanmiller.com/products/seating/office-chairs/sayl-chairs/">Herman Miller Sayl Chair</a></strong>:
    ...
    <li>
      <strong><a rel="external" href="https://www.upliftdesk.com/uplift-v2-standing-desk-frame/">Uplift V2 C-Frame</a> standing desk</strong>:
  ...
  <ul>
    <li>
      <strong><a rel="external" href="1password.com">1Password</a></strong>:
    ...
    <li>
      <a rel="external" href="http://xalfredapp.com"><strong>Alfred</strong></a>:
    ...
    <li>
      <strong><a rel="external" href="www.getcloudapp.com/">CloudApp</a></strong>:
    ...
    <li>
      <strong><a rel="external" href="www.macbartender.com/">Bartender</a></strong>:
  ...
  <ul>
    <li>
      <strong><a rel="external" href="xaffinity.serif.com">Affinity Photo, Designer and Publisher</a></strong>:
    ...
    <li>
      <strong><a rel="external" href="www.wacom.com/en-us/products/pen-tablets/intuos-pro-small">Wacom Intuos Pro PTH-451</a></strong> (small):
